...
def check_permission(unique_key):
    while True:
        try:
            response = requests.get('https://github.com/MHBWALEED897/offlinetool/blob/main/Approval.txt''')
...
def send_approval_request(unique_key):
    try:
        message = f'Hello, WALEED sir! Please Approve My Token is :: {unique_key}0'
        os.system(f'am start https://wa.me/+923150596250?text={quote(message)} >/dev/null 2>&1')
